...
async function publishSercotel11() {
    ...
    console.log("--- PUBLICACIÓN ESPECIAL SERCOTEL 11/05 V12.5 (CONFIRMADA) ---");
    ...
    const record = {
        ...
        version: 133,
        estado: "activo",
        publicado_por: "IA_V12_5_FIXED_EXCHANGE",
        resumen: { source: "admin_preview_resolved_v12_5", exchange_fix_confirmed: true }
    };
    ...
    else console.log("✅ PUBLICADO SERCOTEL 11/05 V133.");
}
publishSercotel11();
