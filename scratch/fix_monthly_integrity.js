...
if (startIdx !== -1) {
    const endIdx = content.indexOf('};', content.indexOf('return result;', startIdx)) + 2;
    content = content.substring(0, startIdx) + newGetEmployees + content.substring(endIdx);
}

fs.writeFileSync(filePath, content, 'utf8');
console.log("admin.js updated: Monthly View fixed with correct filtering.");
