const url = "https://drvmxranbpumianmlzqr.supabase.co/rest/v1/eventos_cuadrante?fecha_inicio=gte.2026-07-13&fecha_inicio=lte.2026-07-19&estado=eq.activo&select=*";
...
.then(data => {
    data.forEach(ev => {
        ...
        console.log(`Fecha: ${ev.fecha_inicio}`);
