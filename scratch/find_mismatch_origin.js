...
for (let lineIdx = 0; lineIdx < lines.length; lineIdx++) {
    ...
    // Log any line where the balance INCREASES and stays increased across many lines
    if (parens !== 0 && oldParens === 0) {
         console.log(`Mismatch STARTED at line ${lineIdx + 1}: ${line.trim()}`);
    }
}
