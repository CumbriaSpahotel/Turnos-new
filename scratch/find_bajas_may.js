...
async function findBajasMay() {
    console.log("--- FINDING BAJAS/PERMISOS MAYO 2026 ---");
    ...
    events.forEach(ev => {
        console.log(`- ${ev.fecha_inicio}: ${ev.tipo} | Empleado: ${ev.empleado_id} | Sustituto: ${ev.empleado_destino_id || ev.sustituto_id}`);
    });
}
